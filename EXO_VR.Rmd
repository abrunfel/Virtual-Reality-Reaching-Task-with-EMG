...
```{r Import Data}
# Mac computer
# setwd('//Users//alexbrunfeldt//Dropbox//Catholic U//VR_EXO//post compile')
# p.table = read_xlsx('//Users//alexbrunfeldt//Dropbox//Catholic U//VR_EXO//VR_participant_list.xlsx')

# PC computer
setwd('C:\\Users\\Alex\\Dropbox\\Catholic U\\VR_EXO\\post compile') # PC
...
colnames(vr.data) = c('Subject', 'Condition', 'Block', 'Trial', 'Target',
                      ...
                      'peak.vel.rh', 'time2.peak.vel.rh') # rename variables
...
aov_ez(data = subset(vr.data.mbb, !Block %in% c(3,5)), id = "Subject", dv = "rel.cont", within = "Condition")
# Followup t-tests
t.test(subset(vr.data.mbb, Block == 1 & Condition == "Baseline")$rel.cont, subset(vr.data.mbb, Condition == "RH weighted")$rel.cont, paired = T)
t.test(subset(vr.data.mbb, Block == 1 & Condition == "Baseline")$rel.cont, subset(vr.data.mbb, Condition == "LH weighted")$rel.cont, paired = T)
t.test(subset(vr.data.mbb, Condition == "LH weighted")$rel.cont, subset(vr.data.mbb, Condition == "RH weighted")$rel.cont, paired = T)
