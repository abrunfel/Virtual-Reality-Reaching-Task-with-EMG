...
% Current version coded on 4/5/21
...
%% Main Loop
% Runs ALL files for a given participant and saves one output .mat for each
% trial. This code is exactly like "vr_exo_kinematics_emg_indiv.m", except
% that it allows for the bulk processing by subject. If you want to look
% more closely at individual trials, use the "..._indiv.m" file.
